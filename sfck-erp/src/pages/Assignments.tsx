...
export const Assignments = () => {
  ...
  const tappingData = useMemo(() => {
    ...
    return assignments.filter(a => a.type === 'tapping' && a.date === selectedDate && (selectedEstate === 'all' || a.estate === selectedEstate)).map(a => {
  ...
  const generalData = useMemo(() => {
    ...
    return assignments.filter(a => a.type === 'general' && a.date === selectedDate && (selectedEstate === 'all' || a.estate === selectedEstate)).map(a => {
      const est = ESTATES.find(e => e.id === a.estate);
